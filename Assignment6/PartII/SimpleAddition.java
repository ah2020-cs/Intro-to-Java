...
public class SimpleAddition extends JFrame {
    ...
    public JPanel createContentPane (){
        ...
        //calls SumListener class
        SumListener Listener = new SumListener();
        addend1Field.addActionListener(Listener);
        addend2Field.addActionListener(Listener);
    ...
    private class SumListener implements ActionListener {
    	// created a class to compute sum 
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            System.out.println("Sum Generated: " + sum);
        }
    }
